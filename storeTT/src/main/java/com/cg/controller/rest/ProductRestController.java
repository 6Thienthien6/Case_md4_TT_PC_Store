...
//        List<ProductDTO> productDTOS = productService.getAllProductWhereDeletedIsFalse();
//        return new ResponseEntity<>(productDTOS, HttpStatus.OK);
        return new ResponseEntity<>(productService.getAllProductWhereDeletedIsFalse(), HttpStatus.OK);
    }
